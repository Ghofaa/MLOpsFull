    ...
    stages {
        ...
        stage('Monitoring Rules + Act (main push)') {
            ...
            steps {
                ...
                %VENV_DIR%\\Scripts\\python.exe -u scripts\\monitor_alerts.py --drift-log logs\\error.log --performance artifacts\\monitoring\\performance_timeseries.json --output artifacts\\alerts\\latest_alert.json --sliding-f1-threshold 0.0
                set RC=!ERRORLEVEL!
